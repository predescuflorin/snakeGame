...
public class GameAction extends JPanel implements ActionListener{
    ...
    public void gameOver(Graphics g) {
        ...
        g.setFont(new Font("ss", Font.HANGING_BASELINE, 30));
        FontMetrics metrics  =getFontMetrics(g.getFont());
        g.drawString("Sorry - Try again myFriend:)", (SCREEN_WIDTH-metrics.stringWidth("Sorry - Try again"))/2, SCREEN_HEIGHT/2);
    }
